  ...
  const createTemplate = ({ imgUrl, params, storage }) => {
    ...
    template.innerHTML = `
          ...
          <div class="web-component">
            <img src="${imgUrl}" alt="Imagen hosteada junto al WC ${imgUrl}"/>
            ...
            <img src="/favicon.ico" alt="Favicon de la aplicación host"/>
            <a href="/index.html">Link a la aplicación host</a>
          </div>
      `;
